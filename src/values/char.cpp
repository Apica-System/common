...
std::optional<Value*> ValueChar::leftIncrement() {
    return new ValueChar(++this->value.value());
}
...
std::optional<Value*> ValueChar::leftDecrement() {
    return new ValueChar(--this->value.value());
}

std::optional<Value*> ValueChar::times(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
            return new ValueChar(this->value.value() * i8->getValue().value());
        ...
        case common::bytecodes::ApicaTypeBytecode::Bool: {
            const ValueBool *boolean = static_cast<const ValueBool*>(other);
            return new ValueChar(boolean->getValue().value() ? this->value.value() : 0);
        }
...
std::optional<Value*> ValueChar::bitwiseNot() const {
    return new ValueChar(~this->value.value());
}

std::optional<Value*> ValueChar::lessThan(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
...
std::optional<Value*> ValueChar::lessOrEquals(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
            return new ValueBool(this->value.value() <= static_cast<uint8_t>(i8->getValue().value()));
...
std::optional<Value*> ValueChar::greaterThan(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
            return new ValueBool(this->value.value() > static_cast<uint8_t>(i8->getValue().value()));
...
std::optional<Value*> ValueChar::greaterOrEquals(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
            return new ValueBool(this->value.value() >= static_cast<uint8_t>(i8->getValue().value()));
