...
common::bytecodes::ApicaTypeBytecode ValueU16::getKind() const {
    return common::bytecodes::ApicaTypeBytecode::U16;
}

std::optional<Value*> ValueU16::add(const Value *other) const {
    switch (other->getKind()) {
        ...
        case common::bytecodes::ApicaTypeBytecode::U8: {
            ...
            return new ValueU16(this->value.value() + u8->getValue().value());
        }
        ...
        case common::bytecodes::ApicaTypeBytecode::Bool: {
            ...
            return new ValueU16(this->value.value() + boolean->getValue().value());
        }
...
std::optional<Value*> ValueU16::increment() {
    return new ValueU16(this->value.value()++);
}

std::optional<Value*> ValueU16::leftIncrement() {
    return new ValueU16(++this->value.value());
}

std::optional<Value*> ValueU16::subtract(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
            return new ValueI16(this->value.value() - i8->getValue().value());
...
std::optional<Value*> ValueU16::decrement() {
    return new ValueU16(this->value.value()--);
}

std::optional<Value*> ValueU16::leftDecrement() {
    return new ValueU16(--this->value.value());
}

std::optional<Value*> ValueU16::times(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
        ...
        case common::bytecodes::ApicaTypeBytecode::Bool: {
            const ValueBool *boolean = static_cast<const ValueBool*>(other);
            return new ValueU16(boolean->getValue().value() ? this->value.value() : 0);
        }
        ...
        case common::bytecodes::ApicaTypeBytecode::String: {
            ...
            for (uint16_t i = 0; i < this->value.value(); i++)
...
std::optional<Value*> ValueU16::unaryNot() const {
    return new ValueBool(this->value.has_value() ? !this->value.value() : true);
}

std::optional<Value*> ValueU16::bitwiseNot() const {
    return new ValueU16(~this->value.value());
}

std::optional<Value*> ValueU16::lessThan(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
...
std::optional<Value*> ValueU16::lessOrEquals(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
            return new ValueBool(this->value.value() <= static_cast<uint8_t>(i8->getValue().value()));
...
std::optional<Value*> ValueU16::greaterThan(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
            return new ValueBool(this->value.value() > static_cast<uint8_t>(i8->getValue().value()));
...
std::optional<Value*> ValueU16::greaterOrEquals(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
            return new ValueBool(this->value.value() >= static_cast<uint8_t>(i8->getValue().value()));
...
std::optional<Value*> ValueU16::convert(common::bytecodes::ApicaTypeBytecode to) const {
    if (this->value) {
        switch (to) {
            case common::bytecodes::ApicaTypeBytecode::String:
            ...
            case common::bytecodes::ApicaTypeBytecode::Type:
                return new ValueType(common::bytecodes::ApicaTypeBytecode::U16);
...
std::optional<Value*> ValueU16::autoConvert(common::bytecodes::ApicaTypeBytecode to) const {
    if (this->value) {
        switch (to) {
