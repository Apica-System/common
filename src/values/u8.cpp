...
std::optional<Value*> ValueU8::leftIncrement() {
    return new ValueU8(++this->value.value());
}
...
std::optional<Value*> ValueU8::leftDecrement() {
    return new ValueU8(--this->value.value());
}

std::optional<Value*> ValueU8::times(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
        ...
        case common::bytecodes::ApicaTypeBytecode::Bool: {
            const ValueBool *boolean = static_cast<const ValueBool*>(other);
            return new ValueU8(boolean->getValue().value() ? this->value.value() : 0);
        }
        ...
        case common::bytecodes::ApicaTypeBytecode::String: {
            ...
            for (uint8_t i = 0; i < this->value.value(); i++)
...
std::optional<Value*> ValueU8::bitwiseNot() const {
    return new ValueU8(~this->value.value());
}

std::optional<Value*> ValueU8::lessThan(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
...
std::optional<Value*> ValueU8::lessOrEquals(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
            return new ValueBool(this->value.value() <= static_cast<uint8_t>(i8->getValue().value()));
...
std::optional<Value*> ValueU8::greaterThan(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
            return new ValueBool(this->value.value() > static_cast<uint8_t>(i8->getValue().value()));
...
std::optional<Value*> ValueU8::greaterOrEquals(const Value *other) const {
    switch (other->getKind()) {
        case common::bytecodes::ApicaTypeBytecode::I8: {
            const ValueI8 *i8 = static_cast<const ValueI8*>(other);
            return new ValueBool(this->value.value() >= static_cast<uint8_t>(i8->getValue().value()));
